...
suppliers = [
    ...
    # Add secondary suppliers for redundancy
    {
        "supplier_id": "SUP-011",
        ...
        "city": "Vancouver",
        "country": "Canada",
        "website": "www.canadiantimber.ca",
        "contact_email": "sales@canadiantimber.ca"
    },
    {
        "supplier_id": "SUP-012",
        "name": "Korean Metal Works",
        "specialty": "Metal",
        "city": "Seoul",
        "country": "South Korea",
        "website": "www.koreanmetal.kr",
        "contact_email": "info@koreanmetal.kr"
    },
    {
        "supplier_id": "SUP-013",
        "name": "Italian Textile Design",
        "specialty": "Fabric",
        "city": "Milan",
        "country": "Italy",
        "website": "www.italiantextile.it",
        "contact_email": "design@italiantextile.it"
    },
    {
        "supplier_id": "SUP-014",
        "name": "Taiwan Precision Parts",
        "specialty": "Fasteners",
        "city": "Taipei",
        "country": "Taiwan",
        "website": "www.taiwanparts.tw",
        "contact_email": "orders@taiwanparts.tw"
    },
    {
        "supplier_id": "SUP-015",
        "name": "UK Foam Manufacturers",
        "specialty": "Foam",
        "city": "Manchester",
        "country": "United Kingdom",
        "website": "www.ukfoam.co.uk",
        "contact_email": "contact@ukfoam.co.uk"
    },
    {
        "supplier_id": "SUP-016",
        "name": "Mexican Hardware Solutions",
        "specialty": "Hardware",
        "city": "Mexico City",
        "country": "Mexico",
        "website": "www.mexhardware.mx",
        "contact_email": "ventas@mexhardware.mx"
    },
    {
        "supplier_id": "SUP-017",
        "name": "French Electronics SA",
        "specialty": "Electronics",
        "city": "Paris",
        "country": "France",
        "website": "www.frenchelectronics.fr",
        "contact_email": "info@frenchelectronics.fr"
    },
    {
        "supplier_id": "SUP-018",
        "name": "Spanish Glass Industries",
        "specialty": "Glass",
        "city": "Barcelona",
        "country": "Spain",
        "website": "www.spanishglass.es",
        "contact_email": "info@spanishglass.es"
    },
    {
        "supplier_id": "SUP-019",
        "name": "Singapore Adhesive Tech",
        "specialty": "Adhesives",
        "city": "Singapore",
        "country": "Singapore",
        "website": "www.singaporeadhesive.sg",
        "contact_email": "tech@singaporeadhesive.sg"
    },
    {
        "supplier_id": "SUP-020",
        "name": "Polish Packaging Group",
        "specialty": "Packaging",
        "city": "Warsaw",
        "country": "Poland",
        "website": "www.polishpackaging.pl",
        "contact_email": "contact@polishpackaging.pl"
    }
]
...
# Create suppliers.csv with all suppliers
...
print("Created suppliers.csv with 20 global suppliers for redundancy")

# Create part_supplier_options.csv with multiple supplier options per part
...
for part in lowest_level_parts:
    ...
    # Find all suppliers that match this category
    matching_suppliers = [s for s in suppliers if s['specialty'] == category]
    
    if matching_suppliers:
        # Select 2-3 suppliers for each part for redundancy
        num_suppliers = min(len(matching_suppliers), random.randint(2, 3))
        selected_suppliers = random.sample(matching_suppliers, num_suppliers)
        
        for supplier in selected_suppliers:
            # Vary pricing and lead times slightly between suppliers
            lead_time = random.randint(5, 30)
            base_cost = random.uniform(0.5, 50.0)
            
            # Primary suppliers might have better pricing or lead times
            if supplier['supplier_id'] in ['SUP-001', 'SUP-002', 'SUP-003', 'SUP-004', 'SUP-005', 
                                          'SUP-006', 'SUP-007', 'SUP-008', 'SUP-009', 'SUP-010']:
                cost_modifier = 0.9  # 10% discount for primary suppliers
                lead_time_modifier = 0.9  # 10% faster delivery
            else:
                cost_modifier = 1.0
            ...
            mapping = {
                ...
                'lead_time_days': max(3, int(lead_time * lead_time_modifier)),
                'unit_cost': round(base_cost * cost_modifier, 2),
                'minimum_order_quantity': random.randint(10, 100),
                'preferred_supplier': 'Yes' if supplier['supplier_id'] in ['SUP-001', 'SUP-002', 'SUP-003', 'SUP-004', 'SUP-005', 
                                                                          'SUP-006', 'SUP-007', 'SUP-008', 'SUP-009', 'SUP-010'] else 'No'
            }
            part_supplier_mappings.append(mapping)

# Create part_supplier_options.csv to map parts to multiple suppliers
with open('data/bom/part_supplier_options.csv', 'w', newline='') as f:
    writer = csv.writer(f)
    writer.writerow(['part_number', 'part_name', 'supplier_id', 'supplier_name', 'lead_time_days', 
                     'unit_cost', 'minimum_order_quantity', 'preferred_supplier'])
    ...
    for mapping in part_supplier_mappings:
        writer.writerow([
            ...
            mapping['preferred_supplier']
        ])

print("Created part_supplier_options.csv with multiple supplier options per part")
