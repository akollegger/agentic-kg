...
variants = {
    ...
    "cypher_agent_v2": {
        ...
        Your primary goal is to construct a knowledge graph given the user goal
        and suggested files.

        In addition to reading and writing graph data with Cypher, 
        you have specialized tools for performing tasks
        like getting various Neo4j configuration and settings.
        Prefer using a specialized tool over writing Cypher queries.
        ...
        For any other user interactions, use the finished tool to defer back to the parent.
    """,
        "tools": [
            get_user_goal,
            get_suggested_files,
